                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table data-table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php $no = 1; foreach ($perawatan as $val): ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= $val->nm_pasien ?></td>
                                                    ...
                                                    <td>
                                                        <?php if($val->status_perawatan == 'Perawatan Klinik Selesai'): ?>
                                                            <span class="badge bg-success">Selesai</span>
                                                        <?php else: ?>
                                                            <a href="<?= base_url('perawat/klinik/perawatan/'.$val->id_pendaftaran) ?>" class="btn btn-primary btn-sm">Perawatan</a>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
