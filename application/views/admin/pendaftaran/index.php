                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($val->status == 'Proses'): ?>
                                                            <a href="<?= base_url('admin/pendaftaran/verifikasi/'.$val->id_pendaftaran) ?>" class="badge bg-warning verifikasi">Verifikasi</a>
                                                        <?php elseif($val->status == 'Disetujui'): ?>
                                                            <span class="badge bg-primary">Terverifikasi</span>
                                                        <?php endif; ?>    
                                                    </td>
                                                    <td>
                                                        <?= do_formal_date($val->tgl_pendaftaran) ?>
                                                    </td>
                                                    <td>
                                                        <a href="<?= base_url('admin/pendaftaran/delete/') . $val->id_pendaftaran ?>" class="btn btn-danger btn-sm hapus">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <script>
        ...
        item.addEventListener('click', function(e) {
            ...
            Swal.fire({
                ...
                text: "Verifikasi Pendaftaran Layanan Pasien!",
                icon: "warning",
