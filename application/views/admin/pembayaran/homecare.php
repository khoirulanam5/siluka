                            ...
                            <div class="card-body">
                                <div class="row justify-content-between mb-4">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <a href="<?= base_url('admin/pembayaran') ?>" class="btn btn-sm btn-primary">Riwayat Pembayaran Klinik</a>
                                        <a href="<?= base_url('admin/pembayaran/homecare') ?>" class="btn btn-sm btn-primary">Riwayat Pembayaran Homecare</a>
                                    </div>
                                </div>
