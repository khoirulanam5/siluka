                            ...
                            <div class="card-body">
                                <div class="row justify-content-between mb-4">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <a href="<?= base_url('admin/jadwal/add') ?>" class="btn btn-sm btn-primary">Tambah Jadwal</a>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    <table id="datatable" class="table data-table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php $no = 1; foreach ($jadwal as $val): ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= $val->id_jadwal ?></td>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('admin/jadwal/edit/') . $val->id_jadwal ?>" class="btn btn-primary btn-sm">Edit</a>
                                                        <a href="<?= base_url('admin/jadwal/delete/') . $val->id_jadwal ?>" class="btn btn-danger btn-sm hapus">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
