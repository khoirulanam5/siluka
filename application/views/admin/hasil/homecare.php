                            ...
                            <div class="card-body">
                                <div class="row justify-content-between mb-4">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <a href="<?= base_url('admin/hasil') ?>" class="btn btn-sm btn-primary">Riwayat Perawatan Klinik</a>
                                        <a href="<?= base_url('admin/hasil/homecare') ?>" class="btn btn-sm btn-primary">Riwayat Perawatan Homecare</a>
                                    </div>
                                </div>
