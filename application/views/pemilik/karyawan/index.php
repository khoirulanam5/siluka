                            ...
                            <div class="card-body">
                                <div class="row justify-content-between mb-4">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <a href="<?= base_url('pemilik/karyawan/add') ?>" class="btn btn-sm btn-primary">Tambah Data</a>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <?php $no = 1; foreach ($karyawan as $val): ?>
                                                <tr>
                                                    ...
                                                    <td><?= $val->alamat ?></td>
                                                    <td>
                                                        <a href="<?= base_url('pemilik/karyawan/edit/') . $val->id_user ?>" class="btn btn-primary btn-sm">Edit</a>
                                                        <a href="<?= base_url('pemilik/karyawan/delete/') . $val->id_user ?>" class="btn btn-danger btn-sm hapus">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
